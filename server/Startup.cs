...
namespace Totogen
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("TotogenDbConnection"));
            ...
            services.AddScoped<TotogenDbService>();

            services.AddDbContext<Totogen.Data.TotogenDbContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("TotogenDbConnection"));
            });
