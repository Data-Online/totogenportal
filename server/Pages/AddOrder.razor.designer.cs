...
namespace Totogen.Pages
{
    public partial class AddOrderComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            order = new Totogen.Models.TotogenDb.Order(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Totogen.Models.TotogenDb.Order args)
        {
            ...
            try
            {
                var totogenDbCreateOrderResult = await TotogenDb.CreateOrder(order);
                DialogService.Close(order);
            }
            catch (System.Exception totogenDbCreateOrderException)
            {
